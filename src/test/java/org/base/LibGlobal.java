...
public class LibGlobal {
	...
	public static String excelPath = "D:\\12.30PmFrameworkJuneBatch\\TestData\\12.30JuneTestData.xlsx";
	...
	public String getDataFromExcel(String sheetName, int rowNo, int cellNo) {
		String value = null;
		try {
